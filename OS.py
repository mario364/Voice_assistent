...
#os.replace('reanamed-text.txt', 'folder/renamed-text.txt') # заменить (переместить) этот файл в другой каталог

# распечатать все файлы и папки в текущем каталоге os.listdir())